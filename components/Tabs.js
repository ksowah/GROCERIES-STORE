    ...
    <View>
        ...
        >
            ...
            {Platform.OS === "android"? (
                ...
                icon={<FontAwesome5 name="shopping-basket" size={24} style={tw`text-[#009959]`} />}
                style={tw`items-center justify-center`}
                containerStyle={tw`items-center`}
            >
                <View style={tw`absolute justify-center bottom-4 right-0 shadow-2xl h-6 w-6 bg-red-500 border-2 border-white rounded-100`}>
                    <Text style={tw`text-gray-100 font-bold text-[0.7rem] text-center`}>14</Text>
                </View>
            </Tab.Item>
            ) : (
            <Tab.Item
